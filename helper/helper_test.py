...
class HelperTest(unittest.TestCase):
    ...
    def test_get_path(self):
        ...
        expected: Path = Path("repositories/gitlab.com/infra/monitoring")
    ...
    def test_get_path_group_depths_1(self):
        ...
        expected: Path = Path("repositories/github.com/ethereum/go-ethereum")
        value = get_path(self.base_folder, path)
        self.assertEqual(value, expected)
    ...
    def test_get_path_group_depths_2(self):
        ...
        expected: Path = Path("repositories/github.com/ethereum/explorer/api")
        value = get_path(self.base_folder, path)
        self.assertEqual(value, expected)
    ...
    def test_get_path_self_host(self):
        ...
        expected: Path = Path(
            "repositories/gitlab.company.com/company-group/company-app")
        value = get_path(self.base_folder, path)
        self.assertEqual(value, expected)
